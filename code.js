...
function destapar(id){
    ...
    if(tarjetasDestapadas == 1){
        ...
        //Deshabilitar segundo resultado
        tarjeta2.disbled = true;
        ...
        if(primerResultado == segundoResultado){
            ...
            if(aciertos == 8){
                ...
                mostrarMovimientos.innerHTML = `Movimientos: ${movimientos} Ganaste😎🎉🎉`
            }
        }else{
